...
public class AckMulliganNoticeActionHandler implements GameActionHandler {

    private final SetupService setupService;

    @Override
    public GameActionType supportedAction() {
        return GameActionType.ACK_MULLIGAN_NOTICE;
    }

    @Override
    public GameActionExecutionResult execute(GameActionContext context) {
        return setupService.ackMulliganNotice(context);
    }
}
