...
public class PreventDamageNextTurnAttackEffect implements AttackEffect {

    private static final String EFFECT_TYPE = "PREVENT_DAMAGE_NEXT_TURN";
    ...
    public AttackEffectResult apply(AttackEffectContext context) {
        ...
        attackerPokemon.setDamageProtectionThreshold(null);
