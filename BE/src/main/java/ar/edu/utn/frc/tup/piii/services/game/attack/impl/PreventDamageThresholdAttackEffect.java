...
public class PreventDamageThresholdAttackEffect implements AttackEffect {

    private static final String EFFECT_TYPE = "PREVENT_DAMAGE_IF_LEQ";
    ...
    public AttackEffectResult apply(AttackEffectContext context) {
        ...
        int protectedUntilTurn = context.turnNumber() + 1;
        attackerPokemon.setDamageProtectionTurn(protectedUntilTurn);
        attackerPokemon.setDamageProtectionThreshold(context.operation().amount());
        ...
        GameEventDto event = gameEventFactory.publicEvent(
                ...
                Map.of(
                        ...
                        "protectedUntilTurn", protectedUntilTurn,
                        "damageThreshold", context.operation().amount()));
