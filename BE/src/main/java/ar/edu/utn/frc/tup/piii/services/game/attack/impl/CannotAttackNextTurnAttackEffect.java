...
public class CannotAttackNextTurnAttackEffect implements AttackEffect {

    private static final String EFFECT_TYPE = "CANNOT_ATTACK_NEXT_TURN";
    ...
    public AttackEffectResult apply(AttackEffectContext context) {
        ...
        targetPokemon.setAttackLockedTurn(lockedTurn);
