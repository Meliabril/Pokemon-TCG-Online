...
public class IgnoreDefenderEffectsAttackEffect implements AttackEffect {

    public static final String EFFECT_TYPE = "IGNORE_DEFENDER_EFFECTS";
    ...
    public AttackEffectResult apply(AttackEffectContext context) {
        ...
        return AttackEffectResult.ignoringDefenderEffects(List.of(event));
    }
}
