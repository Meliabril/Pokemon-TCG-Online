...
public class IgnoreWeaknessResistanceAttackEffect implements AttackEffect {

    private static final String EFFECT_TYPE = "IGNORE_WEAKNESS_RESISTANCE";
    ...
    public AttackEffectResult apply(AttackEffectContext context) {
        ...
        return AttackEffectResult.ignoringWeaknessAndResistance(List.of(event));
    }
}
