...
class PreventDamageNextTurnAttackEffectTest {
    ...
    @Test
    void shouldSetDamageProtectionTurnOnAttackerPokemon() {
        PreventDamageNextTurnAttackEffect effect =
                new PreventDamageNextTurnAttackEffect(pokemonInPlayStateService, gameEventFactory);
        ...
        assertThat(attackerPokemon.getDamageProtectionTurn()).isEqualTo(4);
