...
class IgnoreWeaknessResistanceAttackEffectTest {

    @Mock
    private GameEventFactory gameEventFactory;

    @Test
    void shouldRequestDamageCalculationWithoutWeaknessAndResistance() {
        IgnoreWeaknessResistanceAttackEffect effect = new IgnoreWeaknessResistanceAttackEffect(gameEventFactory);
